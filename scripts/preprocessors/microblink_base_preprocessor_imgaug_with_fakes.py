...
class MicroblinkBasePreprocessorImgaugWithFakes(BasePreprocessor):
    def __init__(self, input_directory, config_dict, name = "MicroblinkBasePreprocessorImgaugWithFakes"):
