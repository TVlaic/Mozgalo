...
class MicroblinkBasePreprocessorImgaugCenterStabilityLoss(BasePreprocessor):
    def __init__(self, input_directory, config_dict, name = "MicroblinkBasePreprocessorImgaugCenterStabilityLoss"):
    ...
    def get_train_generator(self, batch_size):  
        self.TRAIN_BATCH_SIZE = batch_size * 2      
